...
namespace Covid19Api.Mongo.Scaffolder.Updates
{
    public class GlobalStatisticsUpdateDefinition : DatabaseUpdateDefinition
    {
        ...
        protected override async Task ExecuteAsync()
        {
            ...
            {
                Name = $"{CollectionNames.CountryStatistics}_fetchedAt_descending" 
            });
            
            var collection = this.databaseContext.Database.GetCollection<GlobalStatistics>(CollectionNames.CountryStatistics);
